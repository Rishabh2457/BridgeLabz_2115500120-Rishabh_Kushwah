...
class Bonus
{
    ...
    public static void CalculateTotals(double[,] newSalaryYears, int num)
    {
        ...
        // Display the result
        Console.WriteLine(string.Format("Total Old Salary: {0:C}", totalOldSalary));
        Console.WriteLine(string.Format("Total New Salary: {0:C}", totalNewSalary));
        Console.WriteLine(string.Format("Total Bonus Amount: {0:C}", totalBonus));
    }
    ...
    public static void DisplayData(double[,] updatedData, int numEmployees)
    {
        ...
        {
            Console.WriteLine(string.Format("{0}  {1:C}   {2:C}  {3:C}", i + 1, updatedData[i, 0], updatedData[i, 1], updatedData[i, 2]));
        }
    }
    ...
    static void Main(string[] args)
    {
        ...
        // Display the new salary and bonus
