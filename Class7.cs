...
class SocialMedia
{
    ...
    public static void Main()
    {
        ...
        users.AddUser(new Friend(3, "Rishabh Kushwah", 22));
        users.AddUser(new Friend(2, "Karan Gupta", 21));
        users.AddUser(new Friend(1, "Akshata Dubey", 22));
        users.AddConnection("Rishabh Kushwah", "Karan Gupta");
        users.AddConnection("Karan Gupta", "Akshata Dubey");
        users.AddConnection("Rishabh Kushwah", "Akshata Dubey");
        users.MutualFriends("Akshata Dubey", "Karan Gupta");
        users.DisplayAllFriends("Rishabh Kushwah");
        users.DisplayAllFriends("Karan Gupta");
        users.CountFriends();
        users.RemoveConnection("Rishabh Kushwah", "Karan Gupta");
        users.DisplayAllFriends("Rishabh Kushwah");
        users.DisplayAllFriends("Karan Gupta");
        users.SearchUser("Rishabh Kushwah");
        users.SearchUser(1);
        users.CountFriends();
